...
def get_args(jupyter_notebook):
    ...
    parser.add_argument('-feedback_SNR1', type=int, default=15, help='100 means noiseless feeback')
    parser.add_argument('-feedback_SNR2', type=int, default=15, help='100 means noiseless feeback')
...
args.initial_weights = 'weights/deepcode_bc_noisy_snr3_fb15.pt'
